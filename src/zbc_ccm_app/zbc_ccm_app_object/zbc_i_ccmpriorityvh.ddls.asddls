...
@EndUserText.label: 'VH for Priority'
@ObjectModel.resultSet.sizeCategory: #XS
define view entity ZBC_I_CCMPriorityVH
  as select from    DDCDS_CUSTOMER_DOMAIN_VALUE(
                      p_domain_name : 'ZBC_CCM_PRIORITY') as Values
    left outer join DDCDS_CUSTOMER_DOMAIN_VALUE_T(
                      p_domain_name : 'ZBC_CCM_PRIORITY') as Texts on  Texts.domain_name    = Values.domain_name
