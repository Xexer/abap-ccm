CLASS zcl_bc_ccm_message_elem DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS zcl_bc_ccm_message_elem IMPLEMENTATION.
  METHOD if_sadl_exit_calc_element_read~calculate.
    DATA original_data TYPE STANDARD TABLE OF ZBC_C_CCMMessages WITH EMPTY KEY.
